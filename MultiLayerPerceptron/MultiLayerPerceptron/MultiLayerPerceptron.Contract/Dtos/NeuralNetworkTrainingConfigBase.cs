...
namespace MultiLayerPerceptron.Contract.Dtos
{
    ...
    public abstract class NeuralNetworkTrainingConfigBase
    {
        ...
        /// <summary>
        /// This indicates the factor number that will be multiplied to the random weights generated (for increasing or decreasing it)
        /// </summary>
        [Required]
        ...
        /// <summary>
        /// The input size the neural network is getting 
        /// </summary>
        [Required]
